...
|---|---|---|---|
| **Regularized CSP (RCSP) Framework** | Lotte and Guan (2011) | [Code & software page](https://sites.google.com/site/fabienlotte/research/code-and-softwares) — see note below the table | Developed a unified framework and regularized CSP algorithms — addressing CSP overfitting and noise sensitivity. Includes: CSP, CCSP1, CCSP2, DL_CSP, DL_CSP_auto, DL_CSP_diff, generic_RCSP, GLR_CSP, SR_CSP, SSR_CSP, TR_CSP, WTR_CSP. |
