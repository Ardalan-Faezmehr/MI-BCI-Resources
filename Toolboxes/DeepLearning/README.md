...
|---|---|---|---|
| **Braindecode (ShallowConvNet, DeepConvNet)** | Schirrmeister et al. (2017) | Original repo](https://github.com/robintibor/braindecode/) · [Updated repo](https://github.com/braindecode/braindecode) *(also covers many advanced DL models)* | Introduced end-to-end deep ConvNets for raw EEG decoding — replacing handcrafted features with learned representations. The new repository also covers ShallowConvNet, DeepConvNet, and their hybrid variants. |
